...
set(TARGET              STM32L432xx)
set(CORE			    -mcpu=cortex-m4)
set(ISA                 -mthumb)
set(MFPU                -mfpu=fpv4-sp-d16)
set(MFLOAT_ABI          -mfloat-abi=hard)
set(LINKER_SCRIPT       ${CMAKE_SOURCE_DIR}/${PROJECT_DIR}/STM32L432KCUX_FLASH.ld)
...
set(COMMON_FLAGS "${CORE} ${MFPU} ${MFLOAT_ABI} ${ISA} -ffreestanding -fno-builtin -fno-exceptions")
set(CMAKE_EXE_LINKER_FLAGS  "${ISA} ${CORE} -specs=nosys.specs -Wl,-Map=${MAP_NAME} -fno-exceptions -T${LINKER_SCRIPT}" CACHE INTERNAL "exe link flags")
